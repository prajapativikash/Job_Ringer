...
function Emp_Register() {
   ...
   <div className="bg-gray-700 shadow-2xl rounded-lg p-8 max-w-sm w-full">
      <h2 className="text-white text-center text-2xl mb-6 font-bold"> Employer Register</h2>
      <form action="">
         <div className="mb-4">
            <label className="block mb-1 text-gray-300 text-sm font-medium" for="">Name</label>
            <input
